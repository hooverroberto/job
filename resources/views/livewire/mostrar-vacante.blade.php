<div class="p-10">
    <div class="mb-5">
        ...
        <div class="md:grid md:grid-cols-2 bg-gray-50 p-5">
    ...
    @guest
        <div class="mt-5 bg-gray-50 border border-dashed p-5 text-center">
            <p>
                ¿Deseas aplicar a esta vacante? <a class="font-bold text-indigo-600" href="{{ route('register')}}">Obten una cuenta y aplica </a>
            </p>
        </div>
    @endguest
